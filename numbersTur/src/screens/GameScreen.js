    ...
    <View style={styles.screen}>
      ...
      <Card style={styles.buttonContainer}>
        <Button title='MAYOR' onPress={() => {
           setCurrentGuess (generateRandomBetween(currentGuess, userOption, 0));
        }}/>
        <Button title='MENOR' onPress={() => {
            setCurrentGuess (generateRandomBetween(userOption, currentGuess, 0));
        }}/>
      </Card>
    </View>
  )
